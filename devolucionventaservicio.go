...
func DevolucionventaservicioNuevo(w http.ResponseWriter, r *http.Request) {
	log.Println("Error devolucionventaservicio nuevo 1")
	log.Println("Error devolucionventaservicio nuevo 2")
	log.Println("tipoiva" + TraerParametrosInventario().Ventatipoiva)
	...
	t, err := template.ParseFiles("vista/inicio/Modulo.html", "vista/devolucionventaservicio/devolucionventaservicioNuevo.html", "vista/devolucionventaservicio/devolucionventaservicioScript.html")
...
func DevolucionventaservicioAgregar(w http.ResponseWriter, r *http.Request) {
	...
	if tempDevolucionventaservicio.Accion == "Actualizar" {
		...
		delForm2, err := db.Prepare("DELETE from inventario WHERE codigo=$1 and tipo='Devolucionventaservicio'")
		if err != nil {
			panic(err.Error())
		}
		delForm2.Exec(tempDevolucionventaservicio.Codigo)
	...
	_, err = insForm.Exec(
		...
		tempDevolucionventaservicio.Descuento,
		tempDevolucionventaservicio.Subtotaldescuento19,
		tempDevolucionventaservicio.Subtotaldescuento5,
		tempDevolucionventaservicio.Subtotaldescuento0,
		tempDevolucionventaservicio.Subtotal,
		tempDevolucionventaservicio.Subtotal19,
		tempDevolucionventaservicio.Subtotal5,
		tempDevolucionventaservicio.Subtotal0,
		tempDevolucionventaservicio.Subtotaliva19,
		tempDevolucionventaservicio.Subtotaliva5,
		tempDevolucionventaservicio.Subtotaliva0,
		tempDevolucionventaservicio.Subtotalbase19,
		tempDevolucionventaservicio.Subtotalbase5,
		tempDevolucionventaservicio.Subtotalbase0,
		tempDevolucionventaservicio.TotalIva,
		tempDevolucionventaservicio.Ret2201,
		tempDevolucionventaservicio.Total,
		tempDevolucionventaservicio.Neto,
		tempDevolucionventaservicio.Items,
		tempDevolucionventaservicio.Formadepago,
		tempDevolucionventaservicio.Mediodepago,
		tempDevolucionventaservicio.Resolucionventa,
	...
	//if (tempDevolucionventaservicio.Descuento!="0")	{
	//	fila=fila+1
	//	tempComprobanteDetalle.Fila=strconv.Itoa(fila)
	//	totalCredito+=Flotante(tempDevolucionventaservicio.Descuento)
	//	tempComprobanteDetalle.Cuenta  = parametrosinventario.Ventaserviciodevolucioncuentadescuento
	//	tempComprobanteDetalle.Debito = ""
	//	tempComprobanteDetalle.Credito = tempDevolucionventaservicio.Descuento
	//	InsertaDetalleComprobanteDevolucionventaservicioVenta(tempComprobanteDetalle,tempComprobante,tempDevolucionventaservicio)
	//	log.Println("credito linea" + fmt.Sprintf("%.2f",totalCredito))
	//}
...
func DevolucionventaservicioEditar(w http.ResponseWriter, r *http.Request) {
	...
	miTemplate, err := template.ParseFiles("vista/inicio/Modulo.html", "vista/devolucionventaservicio/devolucionventaservicioEditar.html", "vista/devolucionventaservicio/devolucionventaservicioScript.html")
	fmt.Printf("%v, %v", t, err)
...
func DevolucionventaservicioBorrar(w http.ResponseWriter, r *http.Request) {
	...
	miTemplate, err := template.ParseFiles("vista/inicio/Modulo.html",
		"vista/devolucionventaservicio/devolucionventaservicioBorrar.html", "vista/devolucionventaservicio/devolucionventaservicioScript.html")
	fmt.Printf("%v, %v", t, err)
	log.Println("Error devolucionventaservicio nuevo 3")
	miTemplate.Execute(w, parametros)
...
func DevolucionventaservicioEliminar(w http.ResponseWriter, r *http.Request) {
	...
	Borrarinventario(codigo,"Devolucionventaservicio")
...
func DevolucionventaservicioPdf(w http.ResponseWriter, r *http.Request) {
	...
	var re Resolucionventa = TraerResolucionventa(miDevolucionventaservicio.Resolucionventa)
	...
	pdf.SetHeaderFunc(func() {
		...
		pdf.Ln(5)
		pdf.SetX(80)
		pdf.CellFormat(190, 10, "DEVOLUCION VENTA DE SERVICIO", "0", 0, "C",
			false, 0, "")
		pdf.Ln(5)
		pdf.SetX(80)
...
func DevolucionventaservicioPieDePagina(pdf *gofpdf.Fpdf,miTercero tercero,miDevolucionventaservicio devolucionventaservicio){
	...
	pdf.SetY(229)
	pdf.SetX(15)
	pdf.CellFormat(190, 10, miDevolucionventaservicio.Subtotal, "0", 0, "R",
		false, 0, "")
	pdf.Ln(4)
	pdf.SetX(15)
	pdf.CellFormat(190, 10, miDevolucionventaservicio.Subtotaliva19, "0", 0, "R",
		false, 0, "")
	pdf.Ln(4)
	pdf.SetX(15)
	pdf.CellFormat(190, 10, miDevolucionventaservicio.Subtotaliva5, "0", 0, "R",
		false, 0, "")
	pdf.Ln(4)
	pdf.SetX(15)
	pdf.CellFormat(190, 10, miDevolucionventaservicio.Descuento, "0", 0, "R",
		false, 0, "")
	pdf.Ln(4)
	pdf.SetX(15)
	pdf.CellFormat(190, 10, miDevolucionventaservicio.Total, "0", 0, "R",
		false, 0, "")
